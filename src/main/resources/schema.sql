...
CREATE TABLE IF NOT EXISTS PUBLIC.FRIENDS (
	...
	CONSTRAINT FRIENDS_USER_FROM_FK FOREIGN KEY (USER_FROM) REFERENCES PUBLIC.FILMORATE_USER(ID) ON DELETE CASCADE,
	CONSTRAINT FRIENDS_USER_TO_FK FOREIGN KEY (USER_TO) REFERENCES PUBLIC.FILMORATE_USER(ID) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS PUBLIC.FILM_GENRE (
    ...
    CONSTRAINT FILM_GENRE_FILM_ID_FK FOREIGN KEY (FILM_ID) REFERENCES PUBLIC.FILM(ID) ON DELETE CASCADE,
    CONSTRAINT FILM_GENRE_GENRE_ID_FK FOREIGN KEY (GENRE_ID) REFERENCES PUBLIC.GENRE(ID) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS PUBLIC.FILMORATE_LIKE (
    ...
    CONSTRAINT FILMORATE_LIKE_FILM_ID_FK FOREIGN KEY (FILM_ID) REFERENCES PUBLIC.FILM(ID) ON DELETE CASCADE,
    CONSTRAINT FILMORATE_LIKE_USER_ID_FK FOREIGN KEY (USER_ID) REFERENCES PUBLIC.FILMORATE_USER(ID) ON DELETE CASCADE
);
